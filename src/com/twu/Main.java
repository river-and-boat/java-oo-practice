...
public class Main {
    ...
    private static void UserLogin(Main mainBody)
            throws UserException, HotDegreeException {
        ...
        while (!userPage.equals("5")) {
            ...
            switch (userPage) {
                ...
                case "2":
                    //给热搜事件投票
                    mainBody.userService.voteHotSearchService(user);
                    break;
                case "3":
                    //够买热搜
                    mainBody.userService.buyHotSearchService();
                    break;
                case "4":
                    //添加热搜
                    mainBody.commonService.addHotSearchService();
                    break;
                case "5":
                    //退出
                    break;
        ...
        if (manager == null) {
            ...
            while (!managerPage.equals("4")) {
                ...
                switch (managerPage) {
                    ...
                    case "3":
                        //添加超级热搜
                        mainBody.managerService.addSuperHotSearchService();
                        break;
                    case "4":
                        //退出
                        break;
